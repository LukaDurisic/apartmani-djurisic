...
const rules: Localized[] = [
  { en: "No smoking inside the apartments", hr: "Zabranjeno pušenje u apartmanima" },
  ...
  { en: "Pets on request", hr: "Kućni ljubimci na upit" },
  { en: "Please treat the space as your own home", hr: "Čuvajte prostor kao svoj dom" },
];
      ...
      <div className="g2">
        <Reveal>
          ...
          <div className="arrival">
            <div>
              <div className="label">{t({ en: "Check-in", hr: "Prijava" })}</div>
              <div className="figure">{t({ en: "from 14:00", hr: "od 14:00" })}</div>
            </div>
            <div>
              <div className="label">{t({ en: "Check-out", hr: "Odjava" })}</div>
              <div className="figure">{t({ en: "until 10:00", hr: "do 10:00" })}</div>
            </div>
          </div>
          <p>
            {t({
        ...
        <Reveal delay={100}>
          <div className="eyebrow">{t({ en: "House rules", hr: "Kućni red" })}</div>
